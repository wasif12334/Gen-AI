...
similarty_retriver=vector_store.as_retriever(
...
similarty_result=similarty_retriver.invoke("What is used for agentic ai")
# print(similarty_result)
for sr in similarty_result:
    print(sr.page_content)
...
mmr_result=mmr_retriver.invoke("What is used for agentic ai?what is used in agentic ai ans also tell me the technolqyies which are best for ai agentic ")
# print(mmr_result)
for ms in mmr_result:
    print(ms.page_content)
